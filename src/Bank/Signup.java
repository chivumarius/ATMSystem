...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        setTitle("New Account Application For - Page 1");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t6.getText().equals("")){
                ...
                String q1 = "insert into signup values('" + form_number + "', '" + name + "','" + father_name+"','" + date_of_birth +"','"+ gender  +"','"+ email  +"','" + marital_status +"','"+address+"','"+ city + "', '" + pin_code + "', '" + state+"')";
