...
public class Signup3 extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String pin_code = "" + Math.abs(first3);
        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(account_type.equals("")){
                    ...
                    // Insert into Signup3 & Login
                    String q1 = "insert into signup3 values('" + form_number + "', '"+ account_type +"', '" + card_number + "', '" + pin_code + "', '" + facility + "')";
                    String q2 = "insert into login values('" + form_number + "' , '" + card_number + "', '" + pin_code + "')";
